...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        -c '{"function": "createModel","Args":["{\"ModelID\":\"model_autoencoder_attack_3\",\"NodeID\":\"value1\", \"ModelDescription\":\"Autoencoder for flooding attack detection\",\"MalciousPrecision\": 0.99, \"MalciousRecall\": 0.99, \"BenignPrecision\": 0.99, \"BenignRecall\": 0.99, \"Hash\":\"eyJleHAiOjE2MjcwMTc5NDUsInghgdfduYW1lIjoiVGVzdCIsIm9yZ05hbWUiOiJPcmcxIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjI2OTgxOTQ1fQ\", \"TrustComposition\": \"QoS\"}"]}'
