...
chaincodeInvokeInit() {
    ...
    peer chaincode invoke -o orderer.digiblocks.com:7050 \
        ...
        --peerAddresses peer0.org4.digiblocks.com:13051 --tlsRootCertFiles $PEER0_ORG3_CA \
        --peerAddresses peer0.org5.digiblocks.com:15051 --tlsRootCertFiles $PEER0_ORG3_CA \
	--isInit -c '{"Args":[]}'
