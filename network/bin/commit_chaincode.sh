...
commitChaincodeDefination() {
    ...
    peer lifecycle chaincode commit -o 10.128.0.10:7050 --ordererTLSHostnameOverride orderer.digiblocks.com \
        --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA \
        --channelID $CHANNEL_NAME --name ${CC_NAME} \
        --collections-config $PRIVATE_DATA_CONFIG \
        --peerAddresses 10.128.0.10:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
