...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        -c '{"function": "createModel","Args":["{\"ModelID\":\"model_svm_attack_2\",\"NodeID\":\"value1\", \"ModelDescription\":\"SVM Model for version number attacks\",\"MalciousPrecision\": 0.66, \"MalciousRecall\": 0.94, \"BenignPrecision\": 0.89, \"BenignRecall\": 0.51, \"Hash\":\"eyJleHAiOjE2MjcwMTc5NDUsInVzZXJuYW1lIjoiVGVzdCIsIm9yZ05hbWUiOiJPcmcxIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjI2OTgxOTQ1fQ\", \"TrustComposition\": \"QoS\"}"]}'
